...
<head>
    ...
    <title>Abduazam's blog | @yield('title')</title>
...
<nav class="navbar navbar-expand-md px-5 py-4 {{ request()->is('/') ? '' : 'border-bottom sticky-top shadow-sm' }}">
    <div class="container px-md-5">
        <a class="navbar-brand font-2 bold" href="{{ url('/') }}">Abduazam's blog</a>
...
<footer class="footer container-fluid pt-5 pb-3">
    <p class="text-muted text-center mb-0 small font-2">© 2022 abduazam.uz</p>
</footer>
